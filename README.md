...
| --- | --- |
| **[Signal Integrity &amp; High-Speed Digital Design](https://github.com/BrendanJamesLynskey/Signal_Integrity)** | **The companion series: seventeen decks, 188 slides.** [Crosstalk](https://brendanjameslynskey.github.io/Signal_Integrity/06-crosstalk/) computes the NEXT and FEXT of section 05; the four-deck [jitter section](https://brendanjameslynskey.github.io/Signal_Integrity/07-total-jitter/) decomposes what sections 02 and 03 describe, and shows why [DJ(&delta;&delta;) is not the peak-to-peak value](https://brendanjameslynskey.github.io/Signal_Integrity/08-dual-dirac/); the four-deck [power-integrity section](https://brendanjameslynskey.github.io/Signal_Integrity/11-pdn-impedance/) computes the supply-noise coupling path and ends with the [four routes from the rail to the eye](https://brendanjameslynskey.github.io/Signal_Integrity/14-pi-meets-si/); [Measurement](https://brendanjameslynskey.github.io/Signal_Integrity/16-measurement-and-correlation/) and [COM](https://brendanjameslynskey.github.io/Signal_Integrity/17-com-and-compliance/) cover section 06's testing and compliance material |
